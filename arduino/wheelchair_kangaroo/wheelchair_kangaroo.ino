...
//#define USE_USBCON //Use the following line if you have a Leonardo or MKR1000 or any other device that has a native USB port, which is different than on the Arduino UNO, MEGA.
...
float angle_error_factor = 0.9;screen /dev/ttyUSB0 9600
...
//**********Kangaroo Setup**********//  
  ...
  // Drive.units(974, 16384);  //calculated by encoder calculator on kangaroo website by piyush
  // Turn.units(360, 25369);   //calculated by encoder calculator on kangaroo website by piyush
  
  Drive.units(1005, 16384);  //512 of encoder
  Turn.units(360, 28416);   //512
