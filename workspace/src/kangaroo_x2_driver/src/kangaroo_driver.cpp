...
void kangaroo::JointTrajCB(const trajectory_msgs::JointTrajectoryPtr &msg)
{
	...
	channel_2_speed = turn_to_encoder_lines(channel_2_speed)*(180.0/3.14159265359); // real to quadrature * radians to degrees
