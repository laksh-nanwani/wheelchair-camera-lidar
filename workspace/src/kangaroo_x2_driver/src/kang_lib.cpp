...
size_t write_kangaroo_speed_command(unsigned char address, char channel, int speed, unsigned char* buffer)
{
	...
	data[length] = (unsigned char)channel;
	length++;
	data[length] = 32;  // def : 32 ; 	move flags
	length++;
	data[length] = 2;  // Speed
	length++;
...
// size_t write_kangaroo_units_command(unsigned char address, char channel, int speed, unsigned char* buffer)
// {
// 	unsigned char data[9] = { 0 };
// 	size_t length = 0;
// 	data[length] = (unsigned char)channel;
