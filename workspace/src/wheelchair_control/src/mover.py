...
class MoterControl:
	...
	def __init__(self):
		...
		#self.saber = Sabertooth(port, baudrate=9600, address=128, timeout=0.1)
		rospy.Subscriber("diff/cmd_vel", Twist, self.callback)
	...
	def callback(self,data):
		...
		self.wheel1 = (speed + angle)*150
		self.wheel2 = (-speed + angle)*150
