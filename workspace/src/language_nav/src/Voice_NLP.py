...
class LangNav():
    ...
    def __init__(self):
        ...
        self.lookup_table = {
			...
			"table 6": [9.002, 1.075, 0.000, 0.000, 0.000, 1.000, 0.010],        # Equipments table
			"table 7": [13.472, 1.352, 0.000, 0.000, 0.000, 0.707, 0.707],        # Parth's table
			"table 8": [15.442, 1.255, 0.000, 0.000, 0.000, 0.702, 0.712],        # Damodar's table
            ...
            "gate 3" : [15.327, -4.863, 0.000, 0.000, 0.000, -0.685, 0.728],	    # Faculty cabins' door
