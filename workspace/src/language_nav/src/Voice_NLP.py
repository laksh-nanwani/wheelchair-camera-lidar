...
class LangNav():
    ...
    def __init__(self):
        ...
        # FROM STABLE AND REFACTOR BRANCH

        # self.lookup_table = {
		# 	"table 1": [21.594, -1.615, 0.000, 0.000, 0.000, -0.133, 0.991],        # Laksh's table
        #     "table 2": [14.054, -1.395, 0.000, 0.000, 0.000, -0.707, 0.708],	        # Jaski's table
		# 	"table 3": [12.217, -1.444, 0.000, 0.000, 0.000, -0.782, 0.623],		    # Neel's table
        #     "table 4": [10.252, -0.152, 0.000, 0.000, 0.000, -0.697, 0.717],	        # Bhanu's table
		# 	"table 5": [8.808, -0.933, 0.000, 0.000, 0.000, -0.707, 0.707],         # Rishabh's table
		# 	"table 6": [9.138, 1.570, 0.000, 0.000, 0.000, 1.000, 0.028],        #   Equipments table
		# 	"table 7": [13.472, 1.352, 0.000, 0.000, 0.000, 0.707, 0.707],        # Parth's table
		# 	"table 8": [15.446, 1.340, 0.000, 0.000, 0.000, 0.708, 0.706],        # Damodar's table
        #     "table 9": [20.734, 1.776, 0.000, 0.000, 0.000, 0.701, 0.714],        # Interns' table
        #     "table 10": [6.45, 0.666, 0.000, 0.000, 0.000, 0.676, 0.737],        # Sanket's table
        ...
        self.lookup_table = {
			"table 1": [-0.789, -3.853, 0.000, 0.000, 0.000, -0.994, 0.112],        # Laksh's table
            "table 2": [-0.757, -2.099, 0.000, 0.000, 0.000, -0.999, 0.035],	     # Bhanu's table
			"table 3": [5.103, 5.105, 0.000, 0.000, 0.000, 0.689, 0.725],
            "table 4": [8.594, 2.264, 0.000, 0.000, 0.000, -0.114, 0.993],         # equipments table
			"table 5": [7.405, -4.210, 0.000, 0.000, 0.000, -0.714, 0.700],
            "table 7": [7.405, -2.099, 0.000, 0.000, 0.000, -0.114, 0.993],         #Ansh's table
            "table 8": [8.376, 0.285, 0.000, 0.000, 0.000, 0.078, 0.997],           #TV Table
			"pillar 2": [6.377, -1.142, 0.000, 0.000, 0.000, -0.928, 0.373],
			"pillar 1": [6.627, 2.941, 0.000, 0.000, 0.000, -0.994, 0.113],
			"table 6": [11.617, 1.621, 0.000, 0.000, 0.000, -0.988, 0.157],         # mech lab table 1
            "cupboard 1": [11.617, 1.621, 0.000, 0.000, 0.000, -0.988, 0.157],
            "lab 2": [12.522, 0.343, 0.000, 0.000, 0.000, -0.764, 0.645], # mech lab
            # "table 10": [6.45, 0.666, 0.000, 0.000, 0.000, 0.676, 0.737],
			# "gate 1" : [18.664, -2.658, 0.000, 0.000, 0.000, -0.771, 0.636],
            # "gate 2" : [7.875, 0.279, 0.000, 0.000, 0.000, -0.999, 0.051],
            # "gate 3" : [15.327, -4.463, 0.000, 0.000, 0.000, -0.685, 0.728],
            # "gate 4" : [7.092, -4.063, 0.000, 0.000, 0.000, -0.699, 0.715],
            # "corridor": [12.0, -4.063, 0.000, 0.000, 0.000, -0.699, 0.715],
            # "sim room": [5.092, -1.5063, 0.000, 0.000, 0.000, -0.699, 0.715]
		}
